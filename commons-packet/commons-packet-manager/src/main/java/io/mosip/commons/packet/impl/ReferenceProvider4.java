...
@Component
public class ReferenceProvider4 implements IPacketWriter {
    @Override
    ...
    @Override
    public List<PacketInfo> persistPacket(String id, double version, String schemaJson, String source, String process, boolean offline) {
        return null;
    }
