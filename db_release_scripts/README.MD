...
* **mosip_release_commons_db_deployment.sh:**  DB release deployment script for all database.
...
**Step 2** -> DB Release deployment for all databases, run the **"mosip_release_commons_db_deployment.sh"** script with release version as parameter.  To access and exeute **"mosip_release_db_deployment.sh"** script, follow the below given sample commands:
...
**Step 1** -> DB Revoke deployment for all databases, run the **"mosip_revoke_commons_db_deployment.sh "** script with release version as parameter.  To access and exeute **"mosip_revoke_db_deployment.sh "** script, follow the below given commands:
