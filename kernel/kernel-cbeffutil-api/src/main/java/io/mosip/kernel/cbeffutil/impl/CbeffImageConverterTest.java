...
public class CbeffImageConverterTest {
	...
	public static void main(String[] args) throws Exception {
		...
		FileOutputStream fos = new FileOutputStream(
				new File("C:\\Users\\M1049825\\Documents\\Biometric-Data-Samples\\Biometric-Data-Samples\\ISOImage",
						"LeftIndexFingerImage.iso"));
	...
	private static byte[] getImageAsBytes() throws Exception {
		return Files.readAllBytes(Paths.get(
				"C:\\Users\\M1049825\\Documents\\Biometric-Data-Samples\\Biometric-Data-Samples\\Sample-1\\Finger\\LeftIndexFingerImage.bmp"));
	}
