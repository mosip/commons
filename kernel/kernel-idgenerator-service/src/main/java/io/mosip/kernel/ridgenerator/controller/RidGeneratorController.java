...
/**
 * Spring MVC controller for {@code GET /v1/ridgenerator/generate/rid/{centerid}/{machineid}}.
 *
 * @author Ritesh Sinha
 * @since 1.0.0
 */
...
public class RidGeneratorController {
	 ...
	 * @return MOSIP wrapper containing the generated RID
	 */
	@ResponseFilter
	...
	@PreAuthorize("@authorizedRoles.hasGenerateRidAccess()")
