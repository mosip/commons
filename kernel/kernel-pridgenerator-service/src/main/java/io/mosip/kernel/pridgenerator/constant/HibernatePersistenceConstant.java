...
public class HibernatePersistenceConstant {
	 ...
	 */
	public static final String JAVAX_PERSISTENCE_JDBC_PASS = "prid_database_password";
	/**
	 * The string field JAVAX_PERSISTENCE_JDBC_USER
	 */
	public static final String JAVAX_PERSISTENCE_JDBC_USER = "prid_database_username";
	/**
	 * The string field JAVAX_PERSISTENCE_JDBC_URL
	 */
	public static final String JAVAX_PERSISTENCE_JDBC_URL = "prid_database_url";
	/**
