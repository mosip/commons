...
@ComponentScan(basePackages = { "io.mosip.kernel.pridgenerator.*", "io.mosip.kernel.idgenerator.prid.*",
		"io.mosip.kernel.crypto.*"},excludeFilters={
				  @ComponentScan.Filter(type=FilterType.ASSIGNABLE_TYPE, value=io.mosip.kernel.pridgenerator.config.HibernateDaoConfig.class),@ComponentScan.Filter(type=FilterType.ASSIGNABLE_TYPE, value=HibernateExceptionDaoConfig.class)})
