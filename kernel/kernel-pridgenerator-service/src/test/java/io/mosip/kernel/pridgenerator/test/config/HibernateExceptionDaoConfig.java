package io.mosip.kernel.pridgenerator.test.config;
...
import io.mosip.kernel.pridgenerator.service.impl.PridServiceImpl;
...
@ComponentScan(basePackages = { "io.mosip.kernel.pridgenerator.*", "io.mosip.kernel.idgenerator.prid.*",
		"io.mosip.kernel.crypto.*"},excludeFilters={
				  @ComponentScan.Filter(type=FilterType.ASSIGNABLE_TYPE, value=io.mosip.kernel.pridgenerator.config.HibernateDaoConfig.class),  @ComponentScan.Filter(type=FilterType.ASSIGNABLE_TYPE, value=HibernateDaoConfig.class), @ComponentScan.Filter(type=FilterType.ASSIGNABLE_TYPE, value=PridServiceImpl.class)})
@EnableTransactionManagement
public class HibernateExceptionDaoConfig implements EnvironmentAware {
	
	private static final Logger LOGGER = LoggerFactory.getLogger(HibernateExceptionDaoConfig.class);
	...
	public LocalContainerEntityManagerFactoryBean entityManagerFactory(final DataSource dataSource) {
		...
		entityManagerFactory.setPackagesToScan("io.mosip.kernel.pridgenerator.entity");
	...
	public PridService pridService() {
		return Mockito.mock(PridServiceImpl.class);
	}
