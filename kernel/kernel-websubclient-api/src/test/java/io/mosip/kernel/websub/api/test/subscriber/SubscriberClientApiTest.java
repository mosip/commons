...
public class SubscriberClientApiTest {
	...
	@Test(expected = WebSubClientException.class)
	public void getFailedContentKafkaHubExceptionTest() throws URISyntaxException {
		mockServer
				.expect(ExpectedCount.once(),
						requestTo(new URI(expectedFailedContentURL)))
				.andExpect(method(HttpMethod.GET))
				.andRespond(withStatus(HttpStatus.OK).contentType(MediaType.APPLICATION_JSON).body("hub.mode=denied"));
		subscriptionExtendedClient.getFailedContent(failedContentRequest);
	}
