...
/**
 * Tests online Vert.x token validation in {@link VertxTokenValidationHelper}
 * (userinfo via RestTemplate): success, HTTP 417/401/403/500, role mismatch,
 * and missing Authorization cookie.
 */
...
public class VertxTokenValidationHelperTest {
	...
	/** Mock RestTemplate used for userinfo HTTP calls. */
    ...
    /** Mock Vert.x HTTP response used when validation writes error status. */
	...
	/**
	 * Asserts online validation returns the userinfo preferred username when
	 * userinfo HTTP 200 and the required role is present.
	 *
	...
	/**
	 * Asserts online validation returns {@code null} when userinfo responds HTTP
	 * 417.
	 *
	 * @throws Exception if the helper call fails
	 */
	...
	/**
	 * Asserts online validation returns {@code null} when the token's roles do
	 * not match the required role list.
	 *
	 * @throws Exception if the helper call fails
	 */
	@Test
	...
	/**
	 * Asserts online validation returns {@code null} when the Authorization
