...
public class PublisherClientApiExceptionsTest {
	...
	@Test
	public void registerTopicAlreadyRegisteredOnErrorTest() throws URISyntaxException {
		mockServer.expect(ExpectedCount.once(), requestTo(new URI("http://localhost:9191/hub")))
				...
				.andRespond(withStatus(HttpStatus.BAD_REQUEST).contentType(MediaType.TEXT_PLAIN)
						.body("topic already registered"));
		publisherClientImpl.registerTopic("demo", "http://localhost:9191/hub");
	}

	@Test
	public void registerTopicAlreadyRegisteredOnDeniedOkTest() throws URISyntaxException {
		mockServer.expect(ExpectedCount.once(), requestTo(new URI("http://localhost:9191/hub")))
				.andExpect(method(HttpMethod.POST))
				.andRespond(withStatus(HttpStatus.OK).contentType(MediaType.APPLICATION_JSON)
						.body("hub.mode=denied&hub.reason=already registered"));
		publisherClientImpl.registerTopic("demo", "http://localhost:9191/hub");
	}

	@Test
	public void registerTopicAlreadyRegisteredInBodyWithoutReasonPairTest() throws URISyntaxException {
		mockServer.expect(ExpectedCount.once(), requestTo(new URI("http://localhost:9191/hub")))
				.andExpect(method(HttpMethod.POST))
				.andRespond(withStatus(HttpStatus.OK).contentType(MediaType.APPLICATION_JSON)
						.body("hub.mode=denied&already registered"));
		publisherClientImpl.registerTopic("demo", "http://localhost:9191/hub");
	}

	@Test(expected = WebSubClientException.class)
	public void registerTopicPublisherNotAuthorizedTest() throws URISyntaxException {
		mockServer.expect(ExpectedCount.once(), requestTo(new URI("http://localhost:9191/hub")))
				.andExpect(method(HttpMethod.POST))
				.andRespond(withStatus(HttpStatus.FORBIDDEN).contentType(MediaType.TEXT_PLAIN)
						.body("publisher is not authorized"));
		publisherClientImpl.registerTopic("demo", "http://localhost:9191/hub");
	}

	@Test
	public void publishUpdateWithHeadersOkTest() throws URISyntaxException {
		...
		publisherClientImpl.publishUpdate("demo", "{\"data\":\"1\"}", MediaType.APPLICATION_JSON_VALUE, headers,
				"http://localhost:9191/hub");
	}

	@Test(expected = WebSubClientException.class)
	public void registerTopicDeniedWithReasonTest() throws URISyntaxException {
		mockServer.expect(ExpectedCount.once(), requestTo(new URI("http://localhost:9191/hub")))
				.andExpect(method(HttpMethod.POST))
				.andRespond(withStatus(HttpStatus.OK).contentType(MediaType.APPLICATION_JSON)
						.body("hub.mode=denied&hub.reason=rejected"));
		publisherClientImpl.registerTopic("demo", "http://localhost:9191/hub");
	}

	@Test
	public void registerHelperNullHubResponseBranchesTest() {
		org.junit.Assert.assertFalse((Boolean) org.springframework.test.util.ReflectionTestUtils
				.invokeMethod(PublisherClientImpl.class, "isTopicAlreadyRegistered", new Object[] { null }));
		org.junit.Assert.assertFalse((Boolean) org.springframework.test.util.ReflectionTestUtils
				.invokeMethod(PublisherClientImpl.class, "isPublisherNotAuthorized", new Object[] { null }));
		org.springframework.test.util.ReflectionTestUtils.invokeMethod(PublisherClientImpl.class, "logRegisterFailure",
				"demo", "http://localhost:9191/hub", null, 500);
	}

	@Test(expected = WebSubClientException.class)
	public void registerTopicServerErrorTest() throws URISyntaxException {
		mockServer.expect(ExpectedCount.once(), requestTo(new URI("http://localhost:9191/hub")))
				.andExpect(method(HttpMethod.POST))
				.andRespond(withStatus(HttpStatus.INTERNAL_SERVER_ERROR).body("hub down"));
		publisherClientImpl.registerTopic("demo", "http://localhost:9191/hub");
	}

	@Test(expected = WebSubClientException.class)
	public void unregisterTopicServerErrorTest() throws URISyntaxException {
		mockServer.expect(ExpectedCount.once(), requestTo(new URI("http://localhost:9191/hub")))
				.andExpect(method(HttpMethod.POST))
	...
	@Test(expected = WebSubClientException.class)
	public void publishUpdateServerErrorTest() throws URISyntaxException {
		mockServer.expect(ExpectedCount.once(),
				requestTo(new URI("http://localhost:9191/hub?hub.mode=publish&hub.topic=demo")))
				.andExpect(method(HttpMethod.POST))
				.andRespond(withStatus(HttpStatus.INTERNAL_SERVER_ERROR));
		publisherClientImpl.publishUpdate("demo", "{}", MediaType.APPLICATION_JSON_VALUE, null,
				"http://localhost:9191/hub");
	}

	@Test(expected = WebSubClientException.class)
	public void notifyUpdateServerErrorTest() throws URISyntaxException {
		mockServer.expect(ExpectedCount.once(),
				requestTo(new URI("http://localhost:9191/hub?hub.mode=publish&hub.topic=demo")))
				.andExpect(method(HttpMethod.POST))
				.andRespond(withStatus(HttpStatus.INTERNAL_SERVER_ERROR));
		publisherClientImpl.notifyUpdate("demo", new HttpHeaders(), "http://localhost:9191/hub");
	}
}
