...
public class TokenIdGeneratorImpl implements TokenIdGenerator<String> {
	...
	/** Minutes between {@link SecureRandom} re-initialization from {@code mosip.idgen.tokenid.secure-random-reinit-frequency}. */
	...
	/**
	 * AES-wraps the persisted seed with an incrementing sequence and returns {@link #tokenIdLength} digits.
	 *
	 * @return token id of configured length
	 * @throws TokenIdGeneratorException if seed or sequence cannot be read or written
	 */
