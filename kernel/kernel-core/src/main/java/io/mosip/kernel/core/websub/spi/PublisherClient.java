...
public interface PublisherClient<T, P, H> {
	 ...
	 * @param hubURL url for register endpoint of hub.
	 */
	public void registerTopic(T topic, String hubURL,String authToken);
	 ...
	 * @param hubURL url for unregister endpoint of hub.
	 */
	public void unregisterTopic(T topic, String hubURL,String authToken);
	 ...
	 * @param hubURL      url for publish endpoint of hub.
	 */
	public void publishUpdate(T topic, P payload, String contentType, H headers, String hubURL,String authToken);
	 ...
	 * @param hubURL  url for notify endpoint of hub.
	 */
	public void notifyUpdate(T topic, H headers, String hubURL,String authToken);
