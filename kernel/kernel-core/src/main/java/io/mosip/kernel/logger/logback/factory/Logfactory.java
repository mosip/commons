...
public class Logfactory {
	...
	/**
	 * Returns an SLF4J-backed {@link Logger} for {@code clazz}.
	 *
	 * @param clazz class whose name is used as the logger name
	 * @return {@link io.mosip.kernel.logger.logback.impl.Slf4jLoggerImpl}
	 */
	...
	/**
	 * Stops and unregisters the named file or rolling-file appender.
	 *
	 * @param appendersName Logback appender name
	 */
	...
	/**
	 * Stops every file and rolling-file appender registered by {@link LoggerImpl}.
	 */
