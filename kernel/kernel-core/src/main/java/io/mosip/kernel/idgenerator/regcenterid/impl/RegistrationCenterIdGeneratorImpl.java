...
public class RegistrationCenterIdGeneratorImpl implements RegistrationCenterIdGenerator<String> {
	...
	/**
	 * Allocates the next registration-center id from {@code master.rcid_seq}.
	 *
	 * @return next RCID as a decimal string
	 * @throws RegistrationCenterIdServiceException if the sequence cannot be read or written
	 */
	@Override
