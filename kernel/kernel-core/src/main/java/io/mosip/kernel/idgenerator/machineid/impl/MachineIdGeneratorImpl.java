...
public class MachineIdGeneratorImpl implements MachineIdGenerator<String> {
	...
	/**
	 * Allocates the next machine id from {@code master.mid_seq}.
	 * <p>
	 * The first id is {@code 10^(length-1)}. Concurrent inserts retry on
	 * {@link EntityExistsException}.
	 * </p>
	 *
	 * @return next machine id as a decimal string
	 * @throws MachineIdServiceException if the sequence cannot be read or written
	 */
	@Override
