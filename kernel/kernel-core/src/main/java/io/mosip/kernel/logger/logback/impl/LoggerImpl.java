...
public class LoggerImpl implements Logger {
	 ...
	 *
	 * @param mosipConsoleAppender {@link ConsoleAppender} instance which contains all configurations
	 * @param name                 name of calling class to get logger
	 * @param logLevel             level to apply; {@code null} means {@link LogLevel#DEBUG}
	 */
	...
	/**
	 * Builds a file logger, reusing an appender of the same name when present.
	 *
	 * @param mosipFileAppender {@link FileAppender} instance which contains all configurations
	 * @param name              name of calling class to get logger
	 * @param logLevel          level to apply; {@code null} means {@link LogLevel#DEBUG}
	 */
	...
	/**
	 * Builds a rolling-file logger, reusing an appender of the same name when present.
	 *
	 * @param mosipRollingFileAppender {@link RollingFileAppender} instance which contains all configurations
	 * @param name                     name of calling class to get logger
	 * @param logLevel                 level to apply; {@code null} means {@link LogLevel#DEBUG}
	 */
