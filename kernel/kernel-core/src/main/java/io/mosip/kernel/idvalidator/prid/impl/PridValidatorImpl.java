...
public class PridValidatorImpl implements PridValidator<String> {
	...
	/** Forbidden PRID prefixes from {@code mosip.kernel.prid.not-start-with}. */
	 ...
	 * 
	 * @param id pass a PRID in String format example : String
	...
	/**
	 * Compiles repeating-digit and repeating-block regexes for the given limits.
	 *
	 * @param repeatingLimit      lower bound of digits between two identical digits
	 * @param repeatingBlockLimit minimum length of a repeating digit block
	 */
