package io.mosip.kernel.idgenerator.regcenterid.constant;
...
public enum RegistrationCenterIdConstant {
	/** Numeric base used to compute the first RCID ({@code 10^(length-1)}). */
	ID_BASE(10),
	/** Fetch of the last RCID failed. */
	REG_CEN_ID_FETCH_EXCEPTION("KER-RCG-001", "Error occured while fetching id"),
	/** Insert of the next RCID failed. */
