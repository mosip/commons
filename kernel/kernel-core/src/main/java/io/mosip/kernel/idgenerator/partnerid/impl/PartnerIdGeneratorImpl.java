...
public class PartnerIdGeneratorImpl implements PartnerIdGenerator<String> {
	...
	/**
	 * Allocates the next partner id from {@code master.tspid_seq}.
	 *
	 * @return next partner id as a decimal string
	 * @throws PartnerIdException if the sequence cannot be read or written
	 */
	@Override
