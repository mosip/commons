...
/**
 * Filters candidate VIDs for sequences, repeating blocks, restricted digits, prefix, and length.
 *
...
public class VidFilterUtils {
	...
	/** Forbidden VID prefixes from {@code mosip.kernel.vid.not-start-with}. */
	...
	/**
	 * Compiles repeating-digit and repeating-block regexes from configured limits.
	 */
	@PostConstruct
	...
	/**
	 * Returns {@code true} if {@code id} length is not {@link #vidLength}.
	 *
	 * @param id candidate VID
	 * @return {@code true} when length is wrong
	 */
