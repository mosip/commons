...
/**
 * Builds the shared {@link JsonSchemaFactory} with MOSIP identity-schema keywords.
 * <p>
 * Registers {@code fieldType}, {@code fieldCategory}, {@code bioAttributes},
 * {@code validators}, and {@code lowercased}/{@code uppercased} formats on a
 * Draft-04 library published as Draft-07.
 * </p>
 */
public class IdObjectValidatorHelper {
	...
	/**
	 * Returns the process-wide factory, creating it on first call.
	 *
	 * @return configured {@link JsonSchemaFactory}
	 */
