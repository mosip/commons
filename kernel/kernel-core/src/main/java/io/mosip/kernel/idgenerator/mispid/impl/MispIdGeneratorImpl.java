...
public class MispIdGeneratorImpl implements MispIdGenerator<String> {
	...
	/**
	 * Allocates the next MISPID from {@code pmp.tspid_seq}.
	 *
	 * @return next MISPID as a decimal string
	 * @throws MispIdException if the sequence cannot be read or written
	 */
	@Override
