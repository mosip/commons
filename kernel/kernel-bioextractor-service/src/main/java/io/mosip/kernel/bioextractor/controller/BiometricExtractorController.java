...
public class BiometricExtractorController {
	...
	public ResponseWrapper<BioExtractPromiseResponseDTO> extractTemplates(@RequestBody RequestWrapper<BioExtractRequestDTO> bioExtractReqDTO) throws BiometricExtractionException{
