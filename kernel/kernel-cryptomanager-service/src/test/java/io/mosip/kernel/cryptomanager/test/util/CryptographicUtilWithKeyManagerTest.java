...
public class CryptographicUtilWithKeyManagerTest {
	...
	public void setUp() {
		...
		publicKeyResponse.setPublicKey("");
		when(keyManager.getPublicKey(Mockito.any(), Mockito.any(), Mockito.any())).thenReturn(publicKeyResponse);
		...
		when(keyManager.decryptSymmetricKey(Mockito.any())).thenReturn(symmetricKeyResponseDto);
	}
