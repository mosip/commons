...
public class PartnerCertManagerException extends BaseUncheckedException {
	 ...
	 */
	public PartnerCertManagerException(String errorCode, String errorMessage) {
	 ...
	 */
	public PartnerCertManagerException(String errorCode, String errorMessage, Throwable rootCause) {
