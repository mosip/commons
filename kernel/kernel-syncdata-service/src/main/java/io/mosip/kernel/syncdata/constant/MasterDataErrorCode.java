...
public enum MasterDataErrorCode {
	...
	REGISTARTION_CENTER_DEVICES_FETCH_EXCEPTION("KER-SNC-116",
	...
	REG_CENTER_MACHINE_DEVICE_FETCH_EXCEPTION("KER-SNC-131",
			"Error occurred while fetching Registration Center Machine Device"),
	REG_CENTER_USER_MACHINE_DEVICE_FETCH_EXCEPTION("KER-SNC-132",
			"Error occurred while fetching Registration Center Machine Device"),
	...
	REG_CENTER_USER_HISTORY_FETCH_EXCEPTION("KER-SNC-136",
			"Error occurred while fetching Registration Center User History"),
	REG_CENTER_MACHINE_USER_HISTORY_FETCH_EXCEPTION("KER-SNC-137",
			"Error occurred while fetching Registration Center Machine User History"),
	REG_CENTER_DEVICE_HISTORY_FETCH_EXCEPTION("KER-SNC-138",
			"Error occurred while fetching Registration Center Device History"),
	REG_CENTER_MACHINE_HISTORY_FETCH_EXCEPTION("KER-SNC-139",
			"Error occurred while fetching Registration Center Machine History"),
	...
	REG_CENTER_MACHINE_DEVICE_HISTORY_FETCH_EXCEPTION("KER-SNC-152",
			"Error occurred while fetching Registration Center Machine Device History"),
	...
	MACHINE_PUBLIC_KEY_ALREADY_EXIST("KER-SNC-157",
			"A different public key already exist against the Machine Name received"),
