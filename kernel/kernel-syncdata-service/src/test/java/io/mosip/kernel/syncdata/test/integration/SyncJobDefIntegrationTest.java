...
//	private String url;
	...
	public void setup() {
		// url = new
		// StringBuilder(baseUri).append("?lastupdatedtimestamp=").append(lastUpdatedTime).append("Z").toString();
	...
	@Test
	public void syncJobDefNullLastUpdatedTimeTest() {
		when(syncJobDefRepository.findLatestByLastUpdatedTimeAndCurrentTimeStamp(Mockito.any(), Mockito.any()))
				.thenReturn(syncJobDefs);
	...
	@Test
	public void testSyncJobDataAccessException() {
		when(syncJobDefRepository.findLatestByLastUpdatedTimeAndCurrentTimeStamp(Mockito.any(), Mockito.any()))
				.thenReturn(null);
		syncJobDefService.getSyncJobDefDetails(lastUpdatedTime, currentTimeStamp);
	 ...
	 * syncJobDefUnAuthZException() throws Exception {
	 * 
	 ...
	 * 
	 * @WithUserDetails(value = "reg-officer") public void
	 * syncJobDefForbiddenException() throws Exception {
	 * 
	 * MockRestServiceServer server =
	 * MockRestServiceServer.bindTo(restTemplate).build();
	 ...
	 * 
	 * @WithUserDetails(value = "reg-officer") public void
	 * syncJobDefTokenExpiredException() throws Exception {
	 * 
	 * MockRestServiceServer server =
	 * MockRestServiceServer.bindTo(restTemplate).build();
	 * server.expect(requestTo(url)).andRespond(withUnauthorizedRequest().body(
	 ...
	 * 
	 * @WithUserDetails(value = "reg-officer") public void
	 * syncJobForbiddenException() throws Exception {
	 * 
	 * MockRestServiceServer server =
	 * MockRestServiceServer.bindTo(restTemplate).build();
	 * server.expect(requestTo(url)).andRespond(withStatus(HttpStatus.FORBIDDEN).
	 * body(FORBIDDEN_ERROR_MESSAGE));
	 * syncJobDefService.getSyncJobDefDetails(lastUpdatedTime, currentTimeStamp);
	 * 
	 * }
	 * 
	 ...
	 * 
	 * @WithUserDetails(value = "reg-officer") public void
	 * syncJobSyncServiceException() throws Exception {
	 * 
	 * MockRestServiceServer server =
	 * MockRestServiceServer.bindTo(restTemplate).build();
	 ...
	 * 
	 * @WithUserDetails(value = "reg-officer") public void syncJobServiceException()
	 * throws Exception {
	 * 
	 * MockRestServiceServer server =
	 * MockRestServiceServer.bindTo(restTemplate).build();
	 * server.expect(requestTo(url)).andRespond(withSuccess().body(
	 * TOKEN_EXPIRED_ERROR_MESSAGE));
	 * syncJobDefService.getSyncJobDefDetails(lastUpdatedTime, currentTimeStamp);
	 * 
	 * }
	 ...
	 * 
	 * @WithUserDetails(value = "reg-officer") public void syncJobIOException()
	 * throws Exception {
	 * 
	 * MockRestServiceServer server =
	 * MockRestServiceServer.bindTo(restTemplate).build();
	 * server.expect(requestTo(url)).andRespond(withSuccess().body(JSON_SYNC_JOB_DEF
	 * )); syncJobDefService.getSyncJobDefDetails(lastUpdatedTime,
	 * currentTimeStamp);
	 * 
	 * }
	 */
