...
public interface TitleService {
	 ...
	 * 
	 * @param languageCode input from user language code
	 ...
	 * 
	 * @param titleRequestDto input from user
	 ...
	 * 
	 * @param titles input from user
	 * @return composite primary key of updated row of data
	 * @throws RequestException           when data not found
	 * 
	 * @throws MasterDataServiceException when data not updated successfully
	 */
	 ...
	 * @throws RequestException           when data not found
	 * 
	 * @throws MasterDataServiceException when data not deleted successfully
	 */
