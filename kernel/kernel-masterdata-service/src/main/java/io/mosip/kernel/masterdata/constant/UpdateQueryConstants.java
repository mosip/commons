...
public enum UpdateQueryConstants {
	BLACKLISTED_WORD_UPDATE_QUERY_WITHOUT_DESCRIPTION(
			"UPDATE BlacklistedWords bw SET bw.isActive = :isActive ,bw.updatedBy = :updatedBy , bw.updatedDateTime = :updatedDateTime, bw.word = :word , bw.langCode = :langCode WHERE bw.word = :oldWord and (bw.isDeleted is null or bw.isDeleted = false)"),
