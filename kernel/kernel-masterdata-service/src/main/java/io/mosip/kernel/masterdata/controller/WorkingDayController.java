...
public class WorkingDayController {
	...
	public ResponseWrapper<WeekDaysResponseDto> getWeekDays(
			@PathVariable("registrationCenterId")  String regCenterId,@ValidLangCode(message = "Language Code is Invalid")
	...
	public ResponseWrapper<WorkingDaysResponseDto> getWorkingays(
			@PathVariable("registrationCenterID") String regCenterId, @PathVariable("langCode") String langCode) {
