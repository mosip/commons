...
public enum RegistrationCenterDeviceErrorCode {
	...
	REGISTRATION_CENTER_DEVICE_MAPPING_EXCEPTION("KER-MSD-436", "Error occurred while mapping Device to Registration Center"),
	...
	REGISTRATION_CENTER_ALREADY_MAPPED("KER-MSD-419","Cannot map the Device as it is mapped to another Registration Center"),
