...
REVOKE ALL PRIVILEGES ON ALL TABLES IN SCHEMA kernel FROM :dbuname;

REVOKE ALL PRIVILEGES ON ALL TABLES IN SCHEMA kernel FROM sysadmin;

GRANT SELECT, INSERT, TRUNCATE, REFERENCES, UPDATE, DELETE ON ALL TABLES IN SCHEMA kernel TO :dbuname;
